...
export default function ExportHero() {
    return (
        <section className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] bg-primary px-4 py-12 md:py-20">
            {/* Top zigzag border */}
            <div className="absolute -top-8 md:-top-16 left-0  w-full -translate-y-1">
