        ...
        <div className='flex flex-col items-center bg-secondary justify-center gap-16'>
            <div className='w-4/5 h-[500px] relative'>
                ...
                <Image
                    ...
                    width={400}
                    height={400}
                    className='w-full h-full inverted-radius-bottom-right object-cover rounded-[4rem]'
            ...
            <div className='w-4/5 h-[500px] relative'>
                ...
                <Image
                    ...
                    width={400}
                    height={400}
                    className='w-full h-full inverted-radius-top-left object-cover rounded-[4rem]'
                />
            </div>
        </div>
    )
